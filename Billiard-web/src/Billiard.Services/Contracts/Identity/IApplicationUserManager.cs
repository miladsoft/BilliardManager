...
namespace Billiard.Services.Contracts.Identity
{
    public interface IApplicationUserManager : IDisposable
    {
        ...
        Task<IdentityResult> AddMobile(int userId, string mobile);
        Task<IdentityResult> ConfirmMobile(int userId, isConfirmed confirmed);


        Task<IdentityResult> AddDocFile(int userId, string docfilename);
        Task<IdentityResult> ConfirmDocFile(int userId, isConfirmed confirmed , string description);



        Task<IdentityResult> AddSelfiFile(int userId, string selfifilename);
        Task<IdentityResult> ConfirmSelfiFile(int userId, isConfirmed confirmed , string description);

        Task<IdentityResult> AddAddress(int userId, string address , string postalcode , string code);
        Task<IdentityResult> ConfirmAddress(int userId, isConfirmed confirmed , string description);

        Task<IdentityResult> AddPhoneNumber(int userId, string Phone , string code);
        Task<IdentityResult> ConfirmPhoneNumber(int userId, isConfirmed confirmed , string description);
