        ...
        public async Task<IActionResult> Index(ChangeUserPasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await _emailSender.SendEmailAsync(
                           ...
                           viewNameOrPath: "~/Areas/Dashboard/Views/EmailTemplates/_ChangePasswordNotification.cshtml",
                ...
                return RedirectToAction(nameof(Index), "User", routeValues: new { id = user.Id });
            }
