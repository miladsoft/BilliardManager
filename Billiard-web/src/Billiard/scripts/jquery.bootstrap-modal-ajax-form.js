(function ($) {
    $.bootstrapModalAjaxForm = function (options) {
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.success) {
                            ...
                            var Billiard_Modal = new bootstrap.Modal(document.getElementById('dialogDiv'), {
                                keyboard: true
                            })
                            Billiard_Modal.hide();
        ...
        var mainContainer = "<div id='dialogDiv' class='modal fade' data-bs-backdrop='static' data-bs-keyboard='false'><div id='dialogContent'></div></div>";
